<template>
  <div
    class="product-cards"
    :class="{ fewProducts: productsContainer.length % 2 == 0 }"
  >
    <div
      class="card"
...
export default defineComponent({
  name: "PepperoniProducts",
  data() {
    return {
      catalogListProducts: "pepperoni" as string,
    };
  },
  props: ["favProds", "cart", "productsContainer"],
  async mounted() {
    this.createCatalog("category/" + this.catalogListProducts);
  },
  methods: {
